...
import { ArrowLeft, Filter, GitCompare, Rocket, Badge as BadgeIcon, Eye } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-foreground">Experimentation Summary</h1>
          <p className="text-muted-foreground">View and compare all experiments</p>
        </div>
